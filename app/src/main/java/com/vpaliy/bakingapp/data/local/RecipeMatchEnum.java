...
enum RecipeMatchEnum {
    ...
    INGREDIENT_RECIPES_ID(103,Ingredients.CONTENT_ITEM_TYPE,Tables.RECIPES_INGREDIENTS,RecipeContract.PATH_INGREDIENT+"/*"+RecipeContract.PATH_RECIPE);
